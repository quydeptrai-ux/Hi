...
local Tabs = {
    ...
    Status = Window:AddTab({ Title = "Status and join", Icon = "bar-chart-4" }),
...
local Input = Tabs.Status:AddInput("Input", {
    ...
    local Toggle = Tabs.Ss:AddToggle("MyToggle", {Title = "Spam Join Job Id", Default = false })
