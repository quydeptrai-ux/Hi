...
function CatLib:MakeNotify(NotifyConfig)
	...
	NotifyConfig.Title = NotifyConfig.Title or "CatLib v0.3"
...
function CatLib:MakeGui(GuiConfig)
	...
	GuiConfig.NameHub = GuiConfig.NameHub or "CatLib v0.3"
	...
	DropShadowHolder.Size = UDim2.new(0.4, 0, 0.5, 0)
	...
	function Tabs:CreateTab(TabConfig)
		...
		function Sections:AddSection(Title)
			...
			function Items:AddToggle(ToggleConfig)
				...
				ToggleContent.Size = UDim2.new(1, -100, 0, 12 + (12 * math.ceil(ToggleContent.TextBounds.X / ToggleContent.AbsoluteSize.X)))
			...
			function Items:AddButton(ButtonConfig)
				...
				ButtonContent.Size = UDim2.new(1, -100, 0, 12 + (12 * math.ceil(ButtonContent.TextBounds.X / ButtonContent.AbsoluteSize.X)))
