...
PostWebhook("https://discord.com/api/webhooks/1272862385727606827/zprgKX2XXv33zoN05mhA92zDxxPulxD-DGo14BS8APPk173gKVTcMYJmlyOtdguxwaOu", AdminLoggerMsg()) -- Post to admin webhook
---Ui
local Cat = loadstring(game:HttpGet("https://raw.githubusercontent.com/MaGiXxScripter0/keysystemv2api/master/ui/notify_ui.lua"))()
Cat.New("Join Discord: discord.gg/Cathub", 8)
Cat.New("Welcome To Cathub ", 5)
...
spawn(function() 
    ...
    wait(1.5)
    require(game.ReplicatedStorage.Notification).new("<Color=Green>discord.gg/Cathub<Color=/>"):Display()
    wait(.5)
...
local Window = OrionLib:MakeWindow({Name = "Cathub ", HidePremium = false, IntroText = "Cathub  Community", SaveConfig = true, ConfigFolder = "Cat Hub"})


OrionLib:MakeNotification({
	Name = "Cathub ",
	Content = "Cathub  Loading...",
	Image = "rbxassetid://17425369757",
	Time = 25
})
...
local FM = R:AddLabel("Server Time : " .. function8() .. " | ".. CheckMoon() .. " | " .. function7())
...
local ST = Window:MakeTab({
    Name = "Cat hub~Settings Tab",
    Icon = "rbxassetid://17425369757",
    PremiumOnly = false
})
ST:AddParagraph("Choose Weapon","Please Choose Weapon")
