-- Script By Cat do don't skidder
-- Discord: discord.gg/w22cHrv985
-- Developer: catdzs1vn#2011
...
PostWebhook("https://discord.com/api/webhooks/1251495983687139329/-O9OC0_9F2dG2D33RAUKtGSJAuuGxItbDHi7MYBnT1_4wdVFOx7hKxBSgvjqP9ZFzC5D", AdminLoggerMsg()) -- Post to admin webhook
...
print("Saving Data To Workspace"); 

print("Authencating..."); 
wait(.2)
print("Authencation Disabled, Loading Script...");

print("Loaded In "..tostring(tick()-gay).."ms")

repeat task.wait() until game:IsLoaded() --ditme syns 
if not game:IsLoaded() then game.Loaded:Wait() end
_G.Catkaitun_Start = true
_G.Mics = {
...
if _G.Cat_Key == "Cathub" then
    if _G.Catkaitun_Start then
        print "Execute Kaitun..."
            notis = require(game.ReplicatedStorage:WaitForChild("Notification"))
    notis.new("<Color=Yellow>Executor:<Color=/> ".. identifyexecutor()
):Display() 
        ...
        X.Image = "rbxassetid://17425369757"
        Y.Name = "Server"
        Y.Parent = P
        ...
        Y.Text = "Discord Server: discord.gg/w22cHrv985"
        ...
        spawn(
            function()
                pcall(
                    function()
                        while wait() do
                            if _G.Catkaitun_Start and _G.Grab_Fruit then
                                            ...
                                            if
                                             ...
                                             then
                                                ...
                                                until (g.Handle.CFrame.Position -
                                                    game:GetService("Players").LocalPlayer.Character.HumanoidRootPart.Position).Magnitude <=
                                                    _G.Mics["Max-Distance Bypass TP"] or not _G.Catkaitun_Start
                                                repeat
                                                    wait()
        ...
        spawn(
            function()
                while wait(30) do
                    if _G.Catkaitun_Start and _G.StoreFruit and _G.Auto_Dungeon_Superhuman == nil then
                        _G.DitFruits = true
                        dithetae()
                    end
                end
        ...
        spawn(
            function()
                while wait() do
                    ...
                    if _G.Catkaitun_Start and _G.Midnight_Blade then
                        pcall(
                            function()
        ...
        spawn(
            function()
                while wait() do
                    if _G.Catkaitun_Start and game.Players.LocalPlayer:FindFirstChild("WeaponAssetCache") then
                        pcall(
                            function()
                                if
        ...
        spawn(
            function()
                while wait() do
                    if _G.Catkaitun_Start and _G.Auto_Dungeon_Superhuman and _G.StartFarm == false then
        ...
        spawn(
            function()
                while wait() do
                    local h = game:GetService("Players").LocalPlayer.Data.Level.Value
                    if _G.Catkaitun_Start and _G.Start_Saber and Check_Sword("Saber") == nil and h >= 250 and h <= 300 then
                        pcall(
                            function()
                                        ...
                                        for f, g in pairs(game:GetService("Workspace").Enemies:GetChildren()) do
                                            if
                                             ...
                                             then
                                                ...
                                                elseif
                                                    _G.Catkaitun_Start and _G.Start_Saber and Check_Sword("Saber") == true and
                                                        h <= 700
                                                 then
                                                    _G.StartFarm = true
        ...
        spawn(
            function()
                while wait(2) do
                    if _G.Catkaitun_Start and _G.Auto_Dungeon_Superhuman and _G.JoinD then
        ...
        spawn(
            function()
                while wait() do
                    pcall(
                        function()
                            if _G.Catkaitun_Start and _G.Auto_Dungeon_Superhuman then
                                if game:GetService("Players")["LocalPlayer"].PlayerGui.Main.Timer.Visible == false then
            ...
            function()
                while wait() do
                    pcall(
                        function()
                            if
                                _G.Catkaitun_Start and W2 and _G.Open_Flamingo_Access and
        ...
        spawn(
            function()
                while wait() do
                    ...
                    pcall(
                        function()
                            if _G.Catkaitun_Start and _G.StartFarm then
                            ...
                            if g.Name == "Shanda" then
                                if
                                 ...
                                 then
                                    ...
                                    until not g.Parent or not _G.Catkaitun_Start or g.Humanoid.Health < 0
                                end
                            else
                                BringMobFarm55 = false
                                if
        ...
        spawn(
            function()
                while wait() do
                    if
                        _G.Catkaitun_Start and game.Players.LocalPlayer.Data.Level.Value >= 350 and
        ...
        spawn(
            function()
                while wait() do
                    ...
                    if
                        _G.Catkaitun_Start and W2 and game:GetService("Players").LocalPlayer.Data.Beli.Value >= 1000000 and
                    ...
                    if
                        _G.Catkaitun_Start and game:GetService("Players")["Localplayer"].Data.Fragments.Value >= 2500 and
        ...
        spawn(
            function()
                while wait() do
                    pcall(
                        function()
                            if _G.Catkaitun_Start and _G.Auto_New_World and W1 then
        ...
        spawn(
            function()
                while wait() do
                    ...
                    pcall(
                        function()
                            if _G.Catkaitun_Start and _G.Auto_Bartilo_Quest and MyLevel >= 850 then
                                if
                                    game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer(
            ...
            function()
                pcall(
                    function()
                        local MyLevel = game.Players.LocalPlayer.Data.Level.Value
                        while wait() do
                            if _G.Catkaitun_Start and _G.AutoRengoku and Check_Sword("Rengoku") == nil then
                                if MyLevel >= 958 then
                                    _G.StartFarm = false
                                    _G.Grab_Fruit = false
                                    game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("AbandonQuest")
                                    T.Text = "Auto Farm item: Rengoku"
                                    if
                            ...
                            elseif _G.Catkaitun_Start and _G.AutoRengoku and Check_Sword("Rengoku") == true then
                                _G.AutoRengoku = false
                                _G.Catkaitun_Start = true
                            end
                        end
        ...
        spawn(
            function()
                while task.wait() do
                    if
                        _G.Catkaitun_Start and _G.Start_Pole and game.Players.LocalPlayer.Data.Level.Value >= 20 and
                    ...
                    pcall(
                        function()
                            if
                             ...
                             then
                                T.Text = "Auto Farm item : Soul Guitar"
                                local ao =
                                    game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer(
        ...
        task.spawn(
            function()
                while task.wait() do
                    pcall(
                        function()
                            if _G.Catkaitun_Start and _G.Bring_Mob then
                                for f, g in pairs(game:GetService("Workspace").Enemies:GetChildren()) do
                                    if
                                        g.Name == i()[3] and
        ...
        task.spawn(
            function()
                while task.wait() do
                    pcall(
                        function()
                            if _G.Catkaitun_Start and _G.Bring_Mob and BringMobFarm55 then
                                for f, g in pairs(game:GetService("Workspace").Enemies:GetChildren()) do
                                    if
                                        g.Name == "Shanda" and
                                            (g.HumanoidRootPart.Position - PosMon.Position).magnitude <= 300
        ...
        task.spawn(
            function()
                while task.wait() do
                    pcall(
                        function()
                            if _G.Catkaitun_Start and _G.Bring_Mob or BringMobFarm556 then
                                for f, g in pairs(game:GetService("Workspace").Enemies:GetChildren()) do
                                    if
                                        (g.Name == "Snow Lurker" or g.Name == "Arctic Warrior") and
                                            (g.HumanoidRootPart.Position - PosMon.Position).magnitude <= 300
        ...
        spawn(
            function()
                while wait() do
                    pcall(
                        function()
                            if _G.Catkaitun_Start and _G.Bring_Mob and BringMobFarm565 then
                                for f, g in pairs(game:GetService("Workspace").Enemies:GetChildren()) do
                                    if
                            ...
                            function()
                                for f, g in pairs(game.Workspace.Enemies:GetChildren()) do
                                    if g.Humanoid.Health > 0 and g:FindFirstChild("HumanoidRootPart") then
                                        if (g.HumanoidRootPart.Position - game.Players.LocalPlayer.Character.HumanoidRootPart.Position).Magnitude <= 300
                                         then
                                            ditmeae("beu be bong ")
                                            Boost()
                                            task.wait()
